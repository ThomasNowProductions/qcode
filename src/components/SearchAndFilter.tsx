  ...
  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black placeholder:text-gray-400"
        />
      </div>
  ...
  <div className="flex flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-lg px-3 py-1.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black"
          >
